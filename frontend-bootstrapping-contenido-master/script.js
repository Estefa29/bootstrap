...
var imagenmodal = document.querySelectorAll('.line-down img'); 
var modal = document.querySelector('#modal');
var modalImage = document.querySelector('#modal img');
var closeButton = document.querySelector('#modal-close-button');
var texto=document.querySelectorAll('.line-down h4')
var tipo=document.querySelectorAll('.line-down h5') 
...
for(i = 0; i < imagenmodal.length; i ++){
  imagenmodal[i].addEventListener('click', openModal)
}
